           ...
           $http.post("action.php", data, config).success(function(response){
               if(response.status == 'OK'){
                   if(type == 'edit'){
                       ...
                       $scope.users[$scope.index].idlevel = $scope.tempUserData.idlevel;
                       $scope.users[$scope.index].name = $scope.tempUserData.name;
                       $scope.users[$scope.index].uid = $scope.tempUserData.uid;
                       ...
                       $scope.users[$scope.index].modified = $scope.tempUserData.modified;
                       $scope.users[$scope.index].status = $scope.tempUserData.status;
                   }else{
                       $scope.users.push({
                           id:response.data.id,
                           idlevel:response.data.idlevel,
